...
const Footer1 = () => {
  ...
  return (
    <div style={{backgroundColor:"black",color:"#FFFFFFEB"}}>
        ...
        <img style={{width:"65px",height:"65px",borderRadius:"20px", margin : "0 auto"}} src={appletv_adobe_express} alt="apple logo" />
        ...
        <div style={{
            ...
            marginTop:"20px"}}>
            <div>
            <img style={{width:"140px",height:"60px"}} src="https://tv.apple.com/assets/icons/product_landing_apple_tv_wht-2d0f1bf87f69645b296f58815bae784c.png" alt="appletv" />
            <h4  style={{margin:"0px",padding:"0px"}}>Apple TV</h4>
            </div>
            <div>
            <img style={{width:"100px",height:"60px"}} src="https://tv.apple.com/assets/icons/product_landing_iPhone_wht-8ef88627a27c66699f368cc429cc94a8.png" alt="iphone" />
            ...
            <div>
            <img style={{width:"100px",height:"80px"}} src={macbook_adobe_express} alt="Mac" />
            <h4  style={{margin:"0px",padding:"0px"}}>Mac</h4>
            </div>
            <div>
            <img style={{width:"60px",height:"60px",marginTop:"10px"}} src={Airplay_adobe_express} alt="AirPlay" />
